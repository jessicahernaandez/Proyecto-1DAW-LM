      ...
      <div className="row">
        ...
        <div className="col-md-4 mb-4 animate__animated animate__fadeIn animate__delay-1s">
          <div className="card h-100">
            <img src="/Proyecto-1DAW-LM/imagenes/pupusas.jpg" className="card-img-top" alt="Pupusas de queso" />
        ...
        <div className="col-md-4 mb-4 animate__animated animate__fadeIn animate__delay-1s">
          <div className="card h-100">
            <img src="/Proyecto-1DAW-LM/imagenes/tacos.jpg" className="card-img-top" alt="Tacos al pastor" />
            <div className="card-body">
        ...
        <div className="col-md-4 mb-4 animate__animated animate__fadeIn animate__delay-1s">
          <div className="card h-100">
            <img src="/Proyecto-1DAW-LM/imagenes/tamales.jpg" className="card-img-top" alt="Tamales de pollo" />
            <div className="card-body">
